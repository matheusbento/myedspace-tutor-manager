<div x-data="{ showFilters: false }" class="container px-4 py-8 mx-auto">
    ...
    <div>
        ...
        <input type="text" wire:model.debounce.300ms="liveSearch" placeholder="math, science, english, etc. or 10"
    ...
    <button wire:click="search" class="px-4 py-2 mt-4 text-white rounded-lg fi-button bg-primary">
        Search Tutors
    </button>

    <div class="grid grid-cols-1 gap-4 mt-8 md:grid-cols-6">
